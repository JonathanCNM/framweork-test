...
export function BasicThemeExample() {
  ...
  return (
    <div style={{ background: theme.views.primaryMeshGradientView.background }}>
      ...
      <p className="bodycopy" style={{ color: theme.views.primaryMeshGradientView.bodyCopy }}>
...
export function ViewSwitcherExample() {
  const theme = useLolaTheme(kapitalTheme);
  const [currentView, setCurrentView] = useState<ViewType>('primaryMeshGradientView');
  ...
  return (
    ...
    >
      ...
      <p 
        className="bodycopy" 
        style={{ color: activeView.bodyCopy }}
      >
        ...
        {views.map((view) => (
          <button
            ...
            style={{
              ...
              background: currentView === view ? activeView.backgroundBtn : 'transparent',
              color: currentView === view ? activeView.textColorBtn : activeView.bodyCopy,
...
export function FontSwitcherExample() {
  ...
  const fonts = [
    { name: 'Inter', cdn: 'https://fonts.googleapis.com/css2?family=Inter:wght@400;600;700&display=swap' },
    { name: 'Roboto', cdn: 'https://fonts.googleapis.com/css2?family=Roboto:wght@400;500;700&display=swap' },
    { name: 'Poppins', cdn: 'https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;700&display=swap' },
  ];
    ...
    <div style={{ padding: '2rem' }}>
      ...
      <div style={{ display: 'flex', gap: '1rem', marginTop: '1rem' }}>
        {fonts.map((font) => (
          <button
            ...
            style={{
              padding: '0.75rem 1.5rem',
              background: theme.fontFamily === font.name 
                ? theme.colors.primaryGradient 
                : 'transparent',
              color: theme.fontFamily === font.name 
      ...
      <div style={{ marginTop: '2rem' }}>
        ...
        <p className="bodycopy">
          ...
          This text demonstrates the currently selected font.
        </p>
      </div>
    </div>
  );
...
const darkTheme: LolaThemeConfig = {
  font: {
    ...
    fontfamily: 'Inter',
    fontcdn: 'https://fonts.googleapis.com/css2?family=Inter:wght@400;600;700;800&display=swap'
  },
  colors: {
...
export function CustomThemeExample() {
  ...
  const theme = useLolaTheme(isDark ? darkTheme : kapitalTheme);
